...
public:
	...
	public:
		...
		AxeMapping(float threshold, EventInputGamepad::Input on_positive_value_event, EventInputGamepad::Input on_negative_value_event, cocos2d::RepetitionClock clock);
